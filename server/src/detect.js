...
async function exec(pathFile) {
    console.log(pathFile)
  if (argv.file || pathFile) {
    const pathname = pathFile || path.resolve(argv.file);
    ...
    console.timeEnd('pathname   ', pathname);
...
async function saveImages(imagePath, images, out) {
  ...
  const pngName = filename.replace(ext, '.jpg');
